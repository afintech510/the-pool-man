...
export default function ShopPage() {
  return (
    <>
      ...
      <section id="products" className="bg-slate-950 py-16 sm:py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-10 bg-slate-900 border-2 border-dashed border-slate-300 rounded-xl p-12 text-center min-h-[400px] flex flex-col items-center justify-center">
